...
const editor = useEditor({
    extensions: [StarterKit, Link.configure({ openOnClick: false }), Strike],
...
<template>
        ...
        <div class="overflow-hidden rounded-md border bg-white dark:bg-neutral-900 mx-40">
            <!-- Toolbar -->
            ...
            <!-- Editor -->
            <EditorContent v-if="editor" :editor="editor" class="prose dark:prose-invert min-h-[150px] p-4" />
        </div>
